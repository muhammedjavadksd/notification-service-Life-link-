...
const mailTemplates = {
    newChatMessageEmailTemplate: (userName, msg, fromName) => `
        Dear ${userName},
        ...
        Life Link
    `,
    accountVerificationEmailContent: (userName, token) => `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
    ...
    `,
    fundRaiserPaymentSuccess: (name, amount, title, downloadUrl) => `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
    ...
    `,
    ticketClosedMail: (name, ticketId, title) => `
        <!DOCTYPE html>
        <html>
        <head>
    ...
    `,
    ticketClosedWarningMail: (name, ticketId) => `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
    ...
    `,
    profileUpdateEmailTemplate: (otp, user_name) => `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
    ...
    `,
    bloodRequestEmail: function (blood_group, full_name, location, date) {
